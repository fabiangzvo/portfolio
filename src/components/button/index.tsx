...
function Button(props: ButtonProps) {
  ...
  return (
    <button
      ...
      onClick={onClick}
    >
      <span className="relative text-text w-full px-5 py-2.5 transition-all ease-in duration-75 bg-background rounded-md group-hover:bg-transparent group-hover:text-buttonText max-md:text-4xl">
        {label}
      </span>
    </button>
  );
